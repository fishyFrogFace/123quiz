...
export const toQuestionList = (data: any[]): Question[] =>
  data
...
export const fetchQuiz = async (topic: string) => {
  await randomDelay();
  return fetch(
    `https://quizapi.io/api/v1/questions?apiKey=${API_KEY}&limit=10&category=${topic}&difficulty=easy`,
    {
      headers: {
